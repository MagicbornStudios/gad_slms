...
## A. Skill Invocation
- This skill is invoked when the user mentions `gad-next` or describes a task matching this skill.
...
<objective>
Detect the current project state and automatically invoke the next logical GAD workflow step.
