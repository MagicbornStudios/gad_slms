...
## A. Skill Invocation
- This skill is invoked when the user mentions `gad-plant-seed` or describes a task matching this skill.
...
Consumed by: /gad-new-milestone (scans seeds and presents matches)
</objective>
...
<process>
Execute the plant-seed workflow from @workflows/plant-seed.md end-to-end.
</process>
