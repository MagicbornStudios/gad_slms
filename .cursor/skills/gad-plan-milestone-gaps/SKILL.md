...
## A. Skill Invocation
- This skill is invoked when the user mentions `gad-plan-milestone-gaps` or describes a task matching this skill.
...
One command creates all fix phases — no manual `/gad-add-phase` per gap.
</objective>
