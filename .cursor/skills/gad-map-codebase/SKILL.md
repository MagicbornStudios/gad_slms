...
## A. Skill Invocation
- This skill is invoked when the user mentions `gad-map-codebase` or describes a task matching this skill.
...
<context>
Focus area: {{GAD_ARGS}} (optional - if provided, tells agents to focus on specific subsystem)
