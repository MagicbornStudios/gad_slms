...
## A. Skill Invocation
- This skill is invoked when the user mentions `gad-new-milestone` or describes a task matching this skill.
...
**After:** `/gad-plan-phase [N]` to start execution.
</objective>
...
<context>
Milestone name: {{GAD_ARGS}} (optional - will prompt if not provided)
