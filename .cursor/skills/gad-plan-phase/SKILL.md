...
## A. Skill Invocation
- This skill is invoked when the user mentions `gad-plan-phase` or describes a task matching this skill.
...
<context>
Phase number: {{GAD_ARGS}} (optional — auto-detects next unplanned phase if omitted)
