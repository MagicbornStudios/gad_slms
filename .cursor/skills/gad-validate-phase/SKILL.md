...
## A. Skill Invocation
- This skill is invoked when the user mentions `gad-validate-phase` or describes a task matching this skill.
...
<context>
Phase: {{GAD_ARGS}} — optional, defaults to last completed phase.
</context>
