...
## A. Skill Invocation
- This skill is invoked when the user mentions `gad-update` or describes a task matching this skill.
...
<objective>
Check for GAD updates, install if available, and display what changed.
