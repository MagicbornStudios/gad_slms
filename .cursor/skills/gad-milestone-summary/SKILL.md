...
## A. Skill Invocation
- This skill is invoked when the user mentions `gad-milestone-summary` or describes a task matching this skill.
...
**User input:**
- Version: {{GAD_ARGS}} (optional — defaults to current/latest milestone)
</context>
