...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train a tiny character-level GPT language model.")
    parser.add_argument("--text", type=Path, required=True, help="UTF-8 text file used for next-character prediction.")
    parser.add_argument("--out", type=Path, default=Path("runs/char_lm"))
