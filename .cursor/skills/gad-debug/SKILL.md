...
## A. Skill Invocation
- This skill is invoked when the user mentions `gad-debug` or describes a task matching this skill.
...
<context>
User's issue: {{GAD_ARGS}}

Parse flags from {{GAD_ARGS}}:
...
If {{GAD_ARGS}} provided OR user describes new issue:
