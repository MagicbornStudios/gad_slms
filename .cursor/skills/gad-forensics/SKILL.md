...
## A. Skill Invocation
- This skill is invoked when the user mentions `gad-forensics` or describes a task matching this skill.
...
**User input:**
- Problem description: {{GAD_ARGS}} (optional — will ask if not provided)
</context>
